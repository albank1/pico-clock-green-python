...
class Display:
    ...
    def initialise_fonts(self):
        self.ziku = {
            ...
            # ===== Lowercase letters for Pico-Clock-Green) =====
            "a": self.Character(width=4, rows=[0x00, 0x00, 0x06, 0x08, 0x0E, 0x09, 0x0E]),
            "b": self.Character(width=4, rows=[0x01, 0x01, 0x07, 0x09, 0x09, 0x09, 0x07]),
            "c": self.Character(width=4, rows=[0x00, 0x00, 0x06, 0x09, 0x01, 0x09, 0x06]),
            "d": self.Character(width=4, rows=[0x08, 0x08, 0x0E, 0x09, 0x09, 0x09, 0x0E]),
            "e": self.Character(width=4, rows=[0x00, 0x00, 0x06, 0x09, 0x0F, 0x01, 0x0E]),
            "f": self.Character(width=3, rows=[0x06, 0x09, 0x03, 0x01, 0x03, 0x01, 0x01]),
            "g": self.Character(width=4, rows=[0x00, 0x00, 0x0E, 0x09, 0x09, 0x0E, 0x08]),
            "h": self.Character(width=4, rows=[0x01, 0x01, 0x07, 0x09, 0x09, 0x09, 0x09]),
            "i": self.Character(width=2, rows=[0x01, 0x00, 0x01, 0x01, 0x01, 0x01, 0x03]),
            "j": self.Character(width=3, rows=[0x04, 0x00, 0x04, 0x04, 0x04, 0x04, 0x03]),
            "k": self.Character(width=4, rows=[0x01, 0x01, 0x05, 0x03, 0x03, 0x05, 0x09]),
            "l": self.Character(width=2, rows=[0x03, 0x01, 0x01, 0x01, 0x01, 0x01, 0x03]),
            "m": self.Character(width=5, rows=[0x00, 0x00, 0x0B, 0x15, 0x15, 0x15, 0x11]),
            "n": self.Character(width=4, rows=[0x00, 0x00, 0x07, 0x09, 0x09, 0x09, 0x09]),
            "o": self.Character(width=4, rows=[0x00, 0x00, 0x06, 0x09, 0x09, 0x09, 0x06]),
            "p": self.Character(width=4, rows=[0x00, 0x00, 0x07, 0x09, 0x09, 0x07, 0x01]),
            "q": self.Character(width=4, rows=[0x00, 0x00, 0x0E, 0x09, 0x09, 0x0E, 0x08]),
            "r": self.Character(width=4, rows=[0x00, 0x00, 0x0D, 0x03, 0x01, 0x01, 0x01]),
            "s": self.Character(width=4, rows=[0x00, 0x00, 0x0E, 0x01, 0x06, 0x08, 0x07]),
            "t": self.Character(width=4, rows=[0x02, 0x02, 0x0F, 0x02, 0x02, 0x02, 0x0C]),
            "u": self.Character(width=4, rows=[0x00, 0x00, 0x09, 0x09, 0x09, 0x09, 0x06]),
            "v": self.Character(width=5, rows=[0x00, 0x00, 0x11, 0x11, 0x11, 0x0A, 0x04]),
            "w": self.Character(width=5, rows=[0x00, 0x00, 0x11, 0x11, 0x15, 0x1B, 0x11]),
            "x": self.Character(width=5, rows=[0x00, 0x00, 0x11, 0x0A, 0x04, 0x0A, 0x11]),
            "y": self.Character(width=4, rows=[0x00, 0x00, 0x09, 0x09, 0x09, 0x0F, 0x08]),
            "z": self.Character(width=4, rows=[0x00, 0x00, 0x0F, 0x08, 0x04, 0x02, 0x0F]),
